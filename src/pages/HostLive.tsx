...
export default function HostLive() {
  ...
  if (ended) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
        <div className="text-center max-w-sm bg-white rounded-3xl shadow-card-lg p-10 border border-gray-150">
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      {/* Top bar */}
      <div className="bg-white border-b border-gray-150 shadow-sm sticky top-0 z-10">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            {session && (
              <button onClick={copyCode} className="flex items-center gap-2 px-3 py-1.5 bg-gray-50 border border-gray-200 rounded-xl hover:bg-gray-100 transition-all">
      ...
      <div className="max-w-6xl mx-auto px-4 py-5 w-full flex-1 flex flex-col gap-5">
        {/* Progress */}
        <div className="bg-white border border-gray-150 rounded-2xl shadow-card px-5 py-4">
        ...
        {/* Tabs */}
        <div className="bg-white border border-gray-150 rounded-2xl shadow-card overflow-hidden">
            ...
            {tab === 'slide' && (
              <div>
                {currentStepData
                  ...
                  : <div className="text-center py-8 text-gray-400 text-sm">Workshop complete</div>
                }
            ...
            {tab === 'dashboard' && (
              <div>
                <div className="flex items-center justify-between mb-4">
                  <p className="text-xs font-bold text-gray-500 uppercase tracking-wide">Live responses</p>
